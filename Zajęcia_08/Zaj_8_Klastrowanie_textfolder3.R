...
# Pytanie 1: Czy na podstawie wyników (otrzymanych klastrów) możesz wnioskować o treści dokumentów?

# Odpowiedź: 
# Tak, analiza klastrów pozwala na wnioskowanie o ogólnej treści dokumentów. 
# Dzięki wygenerowanym interaktywnym tabelom oraz chmurom słów dla każdego klastra, 
# możemy zidentyfikować słowa kluczowe, które dominują w danej grupie. 
# Dokumenty wewnątrz jednego klastra wykazują wysokie podobieństwo pod względem 
# częstości występowania tych samych terminów, co sugeruje, że poruszają zbliżoną tematykę. 
# Przykładowo, jeśli w klastrze 1 dominują słowa związane z naturą, a w klastrze 2 z techniką, 
# możemy z dużym prawdopodobieństwem określić profil tematyczny dokumentów bez ich czytania.

# Pytanie 2: Jakich ogólnie obszarów tematycznych dotyczą klastry oraz ile jest tych obszarów?

# Odpowiedź: 
# Liczba zidentyfikowanych obszarów zależy od ustawionego parametru k. W kodzie testowano 
# podziały na 2, 3 oraz 4 grupy. Ostatecznie, przy parametrze k = 4, model podzielił 
# dokumenty na cztery konkretne obszary tematyczne, co widać w chmurach słów:
#
# 1. Tematyka naukowo-badawcza (Klaster 1): Dominują słowa takie jak "ibis", "knowledge", 
#    "context", "information".
# 2. Tematyka społeczno-polityczna (Klaster 2): Główne słowa to "people", "country", 
#    "immigration", "american".
# 3. Tematyka opinii i relacji (Klaster 3): Słowa takie jak "think", "thank", "want", 
#    "going", "people".
# 4. Tematyka biznesu i zarządzania (Klaster 4): Skupiona wokół słów "project", 
#    "management", "work", "system".
#
# Podsumowując, przy k = 4 otrzymujemy najbardziej szczegółowy obraz danych, 
# dzielący korpus na 4 główne nurty tematyczne.
